...
This repository develops the common Blender AI control add-on. Keep organization-specific work in downstream projects. Use official Claude Code login for account mode and Anthropic API keys only when API mode is explicitly selected. Never expose, persist, or copy authentication material.
